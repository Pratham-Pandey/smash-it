    ...
    private:
        void process_data(const std_msgs::msg::String & msg)
        {
            ...
            {   
                ...
                arm_move_time = std::stod(split_data[0]); // 2;   // Here the estimated time is divided by 2 because half the time will be 
                // used for reaching the poisition and the remaining half to move the arm. 
