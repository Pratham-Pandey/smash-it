...
class IkArm : public rclcpp::Node
{
    ...
    private:    
        ...
        // For setting position of the robot 
        // NOTE: The following code is for temporary usage only. It is created to check if the arm is moving correctly.
        // std::shared_ptr<rclcpp::Node> spawn_node = rclcpp::Node::make_shared("spawn_bot");
        rclcpp::Client<gazebo_msgs::srv::SetEntityState>::SharedPtr spawn_client;
