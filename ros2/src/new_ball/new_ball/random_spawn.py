...
class BallSpawner(Node):
    ...
    def spawn_ball(self):
        ...
        #x_c = 0.8 if random.uniform(-0.8, 0.8)>0 else -0.8
        x_c = 0.8
        
        request.initial_pose.position = Point(x= x_c, y=9.0, z=1.0)
    ...
    def apply_force(self):
        ...
        request.wrench.force.x = 0.00  # Apply force in x-direction
        request.wrench.force.y = -55.0       # -0.02
        request.wrench.force.z = 65.0
